...
import {Star, ChatRound, Position, StarFilled, Promotion, ArrowDown, SortDown, SortUp} from "@element-plus/icons-vue";
  ...
  <CommonLayout active-menu="1" v-slot="{ userInfo }">
    ...
    <div class="section-nav-menu">
      ...
      <div class="order-filter">
        ...
        <el-button
            size="small"
            @click="toggleOrderDirection" style="margin-left: 8px;"
        >
