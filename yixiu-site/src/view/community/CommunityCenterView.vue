...
import {ElCollapseTransition,  ElDropdown, ElDropdownMenu, ElDropdownItem } from 'element-plus';
import {
  getPostList,
  getAllPostTags,
  uploadPost,
...
import {Message, Delete, More} from "@element-plus/icons-vue";
...
const buildPostQueryParams = () => {
  ...
  if (postFilterForm.postId !== '' && postFilterForm.postId != null) {
...
watch(() => route.query, (newQuery) => {
  ...
  if (newQuery.postId !== postFilterForm.postId) {
        ...
        >
          <div class="user-header">
            ...
            <div class="user-details">
              <div class="username" @click="JumpToUserProfile(post.userId)">{{ post.username }}</div>
                ...
                <el-dropdown trigger="click">
                  ...
                  <template #dropdown>
                    <el-dropdown-menu>
                      <el-dropdown-item
                          command="delete"
                          v-if="AcceptAdmin(userInfo) || userInfo.userId === post.userId"
